        ...
        <section className="py-24 lg:py-32 bg-gradient-to-b from-gray-50 via-white to-gray-50">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                {
                  gradient: "from-[#1F6BFF] to-[#4FB3FF]",
                  icon: (
                    <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                {
                  gradient: "from-[#2F5F8F] to-[#1F6BFF]",
                  icon: (
                    <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                    </svg>
                ...
                {
                  gradient: "from-[#4FB3FF] to-[#1F6BFF]",
                  icon: (
                    <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <section className="py-24 lg:py-32 bg-white" id="how-it-works">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div className="max-w-4xl mx-auto">
              <div className="relative">
                {/* Connector line */}
                <div className="absolute left-8 top-0 bottom-0 w-px bg-gradient-to-b from-[#1F6BFF] via-[#4FB3FF] to-[#2F5F8F] hidden md:block" />
                    ...
                    <div className="text-center">
                      ...
                      <div className="mt-4 flex items-center justify-center gap-1">
                        {[16, 24, 12, 28, 18, 22, 14, 26, 20, 10, 24, 16, 28, 12, 22, 18, 26, 14, 20, 24].map((h, i) => (
                          <div
                            key={i}
                            className="w-1 bg-gradient-to-t from-[#1F6BFF] to-[#4FB3FF] rounded-full animate-pulse"
                            style={{
                              height: `${h}px`,
        ...
        <section className="py-24 lg:py-32 bg-white">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="relative overflow-hidden rounded-3xl">
              {/* Background */}
              <div className="absolute inset-0 bg-gradient-to-br from-[#1F6BFF] via-[#2F5F8F] to-[#0E2A47]" />
