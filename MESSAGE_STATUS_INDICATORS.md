...
### 1. 👤 Profile/User Message (Blue Icon)
...
### 2. ✅ Validated Agent Message (Green Icon with Checkmark)
...
### 3. 🤖 AI-Generated Message (Purple Icon)
...
│    Sent directly by human           │
└─────────────────────────────────────┘

┌─────────────────────────────────────┐
│ ✅ (Green) - Validated by Profile   │
│    "Thanks for reaching out..."     │
│    AI message approved by owner     │
└─────────────────────────────────────┘
...
┌─────────────────────────────────────┐
│ ℹ️ (Gray) - System Message          │
│    "💭 Queued for human response"   │
│    System notification              │
└─────────────────────────────────────┘
```
...
- ✅ Differentiate between user, agent, and system messages
...
1. **User sends**: "What's your favorite food?" 
   - Shows 👤 blue icon (from profile)
   
2. **Agent responds** (Path A): "Based on my knowledge, I love pizza..."
   - Shows 🤖 purple icon (AI-generated)
   
3. **System message** (Path E): "💭 The AI doesn't have enough context..."
   - Shows ℹ️ gray icon (system notification)

4. **Profile owner reviews and sends**: "Actually, I prefer sushi!"
   - Shows 👤 blue icon (from profile)

5. **Agent pre-approved response**: "Thanks for your question..."
   - Shows ✅ green icon (validated by profile owner)
...
2. Check that agent response shows purple 🤖 icon
3. Send a message as yourself
4. Check that your message shows blue 👤 icon
5. Verify tooltips appear on hover
6. Check system messages show gray ℹ️ icon (Path E scenarios)
