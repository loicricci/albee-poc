...
# Load environment variables (try both local and deployed paths)
if os.path.exists('backend/.env'):
    load_dotenv('backend/.env', override=True)
elif os.path.exists('.env'):
    load_dotenv('.env', override=True)

# Import modules - use relative imports when inside backend package
...
from .timing_utils import PerformanceTracker, format_duration
